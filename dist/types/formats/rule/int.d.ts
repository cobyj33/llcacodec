...
export declare function readLifeRuleInteger(lifeInteger: number): LifeRuleData;
export declare function makeLifeRuleInteger(lifeRuleData: LifeRuleData): number;
